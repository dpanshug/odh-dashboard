  ...
  describe('Schedules', () => {
    ...
    it('duplicates a schedule', () => {
      ...
      pipelineRecurringRunTable
        ...
        .click();
      verifyRelativeURL(
        `/pipelines/${projectName}/pipelineRun/cloneRecurringRun/${mockRecurringRun.recurring_run_id}?runType=scheduled`,
      );
      ...
      // Should be redirected to the schedule details page
      verifyRelativeURL(
        `/pipelines/${projectName}/pipelineRecurringRun/view/${mockDuplicateRecurringRun.recurring_run_id}`,
      );
    });
